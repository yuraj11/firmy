...
@Composable
fun FinancesInfoTab(items: List<CompanyDetailSectionUiModel>) {
    Column(
        modifier = Modifier
        ...
        items.forEach { section ->
            DetailSection(section, spacingBetweenItems = 8.dp)
        }
    }
}
...
@Preview
@Composable
private fun FinancesInfoTabPreview() {
    val items = listOf(
